...
const Register = (props) => {
  ...
  const facebookLogin = () => {
    window.location.href = process.env.REACT_APP_FACEBOOK;
  }
          ...
          {/* <Grid container spacing={1}> */}
            ...
            >
              ...
              <div className="bottom-form">
                ...
                <button className="signup-btn" onClick={login}> Login with Email</button>
                  <p className='subtitle fancy'><span>OR</span></p>
                    <div onClick={facebookLogin}className="fb-btn">
